...
const REGISTRY: Record<string, DomainConfig> = {
  ...
  'theageofabundance.wiki':   { renderer: 'wiki', icon: '𒀄', header: { title: 'A living encyclopedia of post-scarcity civilization', subtitle: 'Explore the Age of Abundance' } },
  ...
  'ageofabundance.wiki':   { renderer: 'wiki', icon: '𒀒', header: { title: 'A living encyclopedia of post-scarcity civilization', subtitle: 'Explore the Age of Abundance' } },
