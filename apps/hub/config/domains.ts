...
const REGISTRY: Record<string, DomainConfig> = {
  ...
  'theageofabundance.wiki':   { renderer: 'wiki', icon: '𒀄', header: { title: 'theageofabundance.wiki', subtitle: 'Reference' } },
  ...
  'ageofabundance.wiki':   { renderer: 'wiki', icon: '𒀒', header: { title: 'ageofabundance.wiki', subtitle: 'Education' } },
