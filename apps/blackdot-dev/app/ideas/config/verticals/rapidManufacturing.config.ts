...
export const marketOpportunity: MarketOpportunity = {
    ...
    directCompetitors: [
      {
        ...
        description: 'Publicly traded, $500M+ revenue, market leader',
        strengths: ['Market leadership', 'Established brand', 'Large revenue base'],
        weaknesses: ['Higher pricing', 'Less agile'],
        productOffering: 'Rapid prototyping and manufacturing services',
      },
      {
        id: 'fast-radius',
        name: 'Fast Radius',
        type: 'direct' as const,
        description: 'Midwest focus, strong aerospace',
        strengths: ['Aerospace expertise', 'Regional presence'],
        weaknesses: ['Limited geographic reach'],
        productOffering: 'Manufacturing services with aerospace focus',
      },
      {
        id: 'shapeways',
        name: 'Shapeways',
        type: 'direct' as const,
        description: 'Consumer/e-commerce focused',
        strengths: ['Consumer market presence', 'E-commerce platform'],
        weaknesses: ['Less B2B focus'],
        productOffering: '3D printing services for consumers and small businesses',
      },
      {
        id: 'regional-job-shops',
        name: 'Regional Job Shops',
        type: 'direct' as const,
        description: 'Regional job shops and contract manufacturers',
        strengths: ['Local relationships', 'Flexible service'],
        weaknesses: ['Limited scale', 'Geographic constraints'],
        productOffering: 'Contract manufacturing services',
      },
      {
        id: 'local-3d-bureaus',
        name: 'Local 3D Printing Service Bureaus',
        type: 'direct' as const,
        description: 'Local 3D printing service bureaus',
        strengths: ['Local presence', 'Personalized service'],
        weaknesses: ['Limited capabilities', 'Small scale'],
        productOffering: 'Local 3D printing services',
      },
    ],
    indirectCompetitors: [
      {
        ...
        description: 'Large companies with in-house manufacturing capabilities',
        strengths: ['Full control', 'No external dependencies'],
        weaknesses: ['High capital requirements', 'Limited flexibility'],
        productOffering: 'Internal manufacturing capabilities',
      },
      {
        id: 'overseas-outsourcing',
        name: 'Overseas Outsourcing',
        type: 'indirect' as const,
        description: 'China, India labor arbitrage',
        strengths: ['Lower costs', 'Large capacity'],
        weaknesses: ['Long lead times', 'Quality concerns', 'Supply chain risks'],
        productOffering: 'Low-cost manufacturing in Asia',
      },
      {
        id: 'traditional-distributors',
        name: 'Traditional Distributors',
        type: 'indirect' as const,
        description: 'Traditional distributors entering marketplace',
        strengths: ['Existing customer relationships', 'Distribution networks'],
        weaknesses: ['Legacy systems', 'Less agile'],
        productOffering: 'Distribution and marketplace services',
      },
      {
        id: 'amazon-business',
        name: 'Amazon Business',
        type: 'indirect' as const,
        description: 'Amazon Business/marketplace entering manufacturing',
        strengths: ['Massive scale', 'Customer base', 'Logistics'],
        weaknesses: ['Less specialized', 'Quality control challenges'],
        productOffering: 'Marketplace and manufacturing services',
      },
    ],
    emergingCompetitors: [
      {
        id: 'hardware-companies',
        name: 'Hardware Companies',
        type: 'emerging' as const,
        description: 'HP, 3D Systems adding software/services',
        strengths: ['Existing hardware expertise', 'Customer relationships'],
        weaknesses: ['Software development challenges', 'Legacy systems'],
        productOffering: 'Hardware with software services',
      },
      {
        id: 'big-tech',
        name: 'Big Tech Companies',
        type: 'emerging' as const,
        description: 'AWS, Google, Microsoft manufacturing initiatives',
        strengths: ['Massive resources', 'Cloud infrastructure', 'AI capabilities'],
        weaknesses: ['Less manufacturing expertise', 'Different business model'],
        productOffering: 'Cloud-based manufacturing platforms',
      },
      {
        id: 'robotics-companies',
        name: 'Robotics Companies',
        type: 'emerging' as const,
        description: 'Robotics companies with manufacturing focus',
        strengths: ['Automation expertise', 'Technology integration'],
        weaknesses: ['Limited market presence', 'High capital requirements'],
        productOffering: 'Robotic manufacturing solutions',
      },
      {
        id: 'ai-automation-startups',
        name: 'AI-Powered Automation Startups',
        type: 'emerging' as const,
        description: 'AI-powered automation startups',
        strengths: ['Innovation', 'Agility', 'AI expertise'],
        weaknesses: ['Limited resources', 'Unproven at scale'],
        productOffering: 'AI-driven manufacturing automation',
      },
    ],
  ...
  drivers: {
    regulatory: ['Increasing complexity of product regulations (FDA, FAA, CE marks)',
      'Supply chain reshoring (near-shoring from Asia)',
      'Sustainability/ESG requirements reducing waste',
      'Customization requirements (regulatory compliance varies by market)'] as unknown as import('@/lib/types/market.types').MarketDriver[],
    technological: ['Continuous hardware improvements (speed, precision, material options)',
      ...
      'Hybrid manufacturing (additive + subtractive) improving quality'] as unknown as import('@/lib/types/market.types').MarketDriver[],
    economic: ['Reducing hardware costs (3D printers becoming commoditized)',
      ...
      'Sustainability cost pressures'] as unknown as import('@/lib/types/market.types').MarketDriver[],
    sources: [sourcesMarket[0], sourcesMarket[1]]
  },
...
export const grantOpportunities: Array<Record<string, unknown>> = [
  {
    id: 'grant-nsf-sbir',
    program: 'SBIR',
    agency: 'NSF',
  ...
  {
    id: 'grant-nist-mep',
    program: 'MEP (Manufacturing Extension Partnership)',
    agency: 'NIST',
