    ...
    directCompetitors: [
      {
        ...
        description: 'Chinese company with U.S. sanctions concerns',
        strengths: ['Large market share', 'Cost-effective products'],
        weaknesses: ['U.S. sanctions concerns', 'Privacy concerns'],
        productOffering: 'Video surveillance systems and cameras',
      },
      {
        id: 'dahua',
        name: 'Dahua',
        type: 'direct' as const,
        description: 'Chinese surveillance company',
        strengths: ['Cost-effective', 'Wide product range'],
        weaknesses: ['Security concerns', 'Limited U.S. market access'],
        productOffering: 'Surveillance cameras and systems',
      },
      {
        id: 'axis-communications',
        name: 'Axis Communications',
        type: 'direct' as const,
        description: 'Swedish surveillance company',
        strengths: ['Strong brand', 'Quality products', 'Global presence'],
        weaknesses: ['Higher pricing'],
        productOffering: 'Network cameras and video surveillance solutions',
      },
      {
        id: 'bosch-security',
        name: 'Bosch Security Systems',
        type: 'direct' as const,
        description: 'Major security systems provider',
        strengths: ['Established brand', 'Comprehensive solutions'],
        weaknesses: ['Legacy systems', 'Less agile'],
        productOffering: 'Integrated security and surveillance systems',
      },
      {
        id: 'milestone-xprotect',
        name: 'Milestone XProtect',
        type: 'direct' as const,
        description: 'Software platform for video management',
        strengths: ['Software expertise', 'Platform approach'],
        weaknesses: ['Hardware dependency', 'Integration complexity'],
        productOffering: 'Video management software platform',
      },
      {
        id: 'genetec',
        name: 'Genetec',
        type: 'direct' as const,
        description: 'Canadian company with strong market share',
        strengths: ['Strong market position', 'Comprehensive platform'],
        weaknesses: ['Higher pricing', 'Complexity'],
        productOffering: 'Unified security platform and video management',
      },
    ],
    indirectCompetitors: [
      {
        id: 'legacy-security',
        name: 'Legacy Security Companies',
        type: 'indirect' as const,
        description: 'AlliedUniversal, G4S and similar companies',
        strengths: ['Established relationships', 'Service expertise'],
        weaknesses: ['Legacy systems', 'Less technology-focused'],
        productOffering: 'Security services with surveillance components',
      },
      {
        id: 'it-integrators',
        name: 'IT Integrators',
        type: 'indirect' as const,
        description: 'IT integrators offering surveillance add-ons',
        strengths: ['Existing IT relationships', 'Integration capabilities'],
        weaknesses: ['Less specialized', 'Limited surveillance expertise'],
        productOffering: 'IT services with surveillance add-ons',
      },
      {
        id: 'cloud-video-platforms',
        name: 'Cloud Video Platforms',
        type: 'indirect' as const,
        description: 'Amazon Rekognition, Google Video Intelligence',
        strengths: ['Cloud infrastructure', 'AI capabilities', 'Scale'],
        weaknesses: ['Less specialized', 'Privacy concerns'],
        productOffering: 'Cloud-based video analytics platforms',
      },
      {
        id: 'consumer-systems',
        name: 'Self-Install Consumer Systems',
        type: 'indirect' as const,
        description: 'Ring, Wyze and similar consumer systems',
        strengths: ['Low cost', 'Easy installation', 'Consumer market'],
        weaknesses: ['Limited features', 'Privacy concerns', 'Not enterprise-grade'],
        productOffering: 'Consumer-grade surveillance systems',
      },
    ],
    emergingCompetitors: [
      {
        ...
        description: 'AI startups adding surveillance capabilities',
        strengths: ['AI expertise', 'Innovation', 'Agility'],
        weaknesses: ['Limited resources', 'Unproven at scale'],
        productOffering: 'AI-powered surveillance solutions',
      },
      {
        id: 'cloud-native-startups',
        name: 'Cloud-Native Surveillance Startups',
        type: 'emerging' as const,
        description: 'Cloud-native surveillance startups',
        strengths: ['Modern architecture', 'Scalability', 'Cloud-first'],
        weaknesses: ['Limited market presence', 'Unproven'],
        productOffering: 'Cloud-native surveillance platforms',
      },
      {
        id: 'autonomous-robotics',
        name: 'Autonomous Robotics',
        type: 'emerging' as const,
        description: 'Autonomous robotics with cameras',
        strengths: ['Mobile surveillance', 'Advanced capabilities'],
        weaknesses: ['High cost', 'Limited deployment', 'Regulatory challenges'],
        productOffering: 'Autonomous robotic surveillance systems',
      },
    ],
