...
function ModelPreview({
  ...
  // Calculate orientation vectors from the rotation (must be before early return)
  const quaternion = useMemo(() => {
    return clonedScene ? new THREE.Quaternion().setFromEuler(euler) : new THREE.Quaternion();
  }, [euler, clonedScene]);
