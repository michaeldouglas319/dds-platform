...
export const marketOpportunity: MarketOpportunity = {
  ...
  drivers: {
    regulatory: [
      'Increased regulatory pressure for retail/facility security compliance',
      'GDPR and privacy law compliance requirements',
      'Government investment in border/infrastructure security',
      'Post-incident security upgrades (post-pandemic, heightened security awareness)'
    ] as unknown as import('@/lib/types/market.types').MarketDriver[],
    technological: [
      'Rapid AI/ML advances in computer vision and detection',
