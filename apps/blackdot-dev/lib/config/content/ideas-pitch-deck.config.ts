...
import { UnifiedSection } from '@/lib/config/content/sections.config';
import { allExpertiseUmbrellas, getFoundingPartnerSummary, certificationPhases, type ExpertiseUmbrella } from '@/lib/config/expertise/faa-expertise.config';
