    ...
    content: {
      ...
      paragraphs: [
        ...
        },
        {
          ...
          description:
            'Skeptics point to siting conflicts, rare-earth supply chains, and the political economy of incumbent fossil interests. Each of these is real; none is thermodynamic. The contested question is not whether cheap clean energy is possible but who captures the rents and who bears the transition costs — a question that ultimately belongs to [[Coordination Abundance]].',
        },
      ],
    },
    display: {
      ...
      paragraphs: [
        {
          ...
          description:
            'Historically, technological capacity has outrun our ability to agree on how to use it. Nuclear power, the internet, and [[Artificial General Intelligence|ML systems]] each demonstrate the pattern: the scientific problem is solved decades before the governance problem is. If abundance is shipped without coordination, it arrives as unequal concentration rather than shared flourishing.',
        },
        {
