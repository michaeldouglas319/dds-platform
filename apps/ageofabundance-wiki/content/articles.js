...
/**
 * Return articles that carry a given tag, sorted by `meta.wiki.lastUpdatedISO`
 * descending. Used by the `/t/[tag]` category page.
 *
 * @param {string} tag — must already be normalized (lowercase, trimmed)
 * @param {import('../content/wiki-meta.js').deriveWikiMeta} deriveWikiMeta
 * @returns {{ article: WikiArticle, meta: ReturnType<typeof import('../content/wiki-meta.js').deriveWikiMeta> }[]}
 */
