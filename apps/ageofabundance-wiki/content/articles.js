...
export const articles = [
  ...
  },
  {
    ...
    content: {
      body: 'If [[Energy Abundance|energy]], compute, and atoms are the material pillars of abundance, coordination is the pillar that decides what we do with them. Without legitimate institutions, open protocols, and [[Verifiable Identity|verifiable identity]], cheap electrons and trained models turn into centralized rents. Coordination abundance asks whether the governance layer can scale at the same pace as the underlying capacity.',
      paragraphs: [
        {
